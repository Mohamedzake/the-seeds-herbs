  ...
  return (
    <section className="bg-gray-50 px-4 py-16 md:py-24 text-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 md:flex md:gap-6 md:mb-16">
          {tabs.map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab)}
              className={classNames(
                "relative  px-4 py-3 md:py-2.5 text-base md:text-lg font-medium transition-colors duration-300",
                activeTab === tab
                  ? "text-emerald-700"
